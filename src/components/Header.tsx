...
const Header = () => {
  return (
    <header>
      <nav className="lg:flex items-center justify-between flex-wrap bg-white p-6 border-solid border-0 border-b-2 border-gray-200 lg:fixed w-full">
        ...
        <div className="w-full block lg:flex lg:flex-grow lg:items-center lg:w-auto flex-wrap">
          ...
          <div className="block items-center flex-wrap lg:flex">
