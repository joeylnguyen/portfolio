  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-white p-6 border-solid border-0 border-b-2 border-gray-200">
      <div className="flex items-center flex-shrink-0 text-gray-800 mr-6">
        <img src={logo} alt="Logo" className="fill-current h-16 w-16 mr-4"></img>
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div className="flex items-center">
          <a href="#responsive-header" className="text-sm px-4 py-2 mr-4 leading-none border rounded text-gray-500 border-gray-500 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 inline-block hover:border-transparent hover:text-white hover:bg-gray-600 mt-4 lg:mt-0">Contact Me</a>
