      ...
      <div className={`${width < 1024 ? 'visible' : 'hidden'} ${showSideNav ? '-translate-x-0 shadow-xl' : 'translate-x-full'} transform top-0 right-0 w-halfScreen h-full bg-gray-100 overflow-auto ease-in-out fixed transition-all duration-500 flex flex-col space-y-10 justify-center p-6 lg:overflow-visible lg:transition-none lg:bg-transparent lg:h-auto lg:relative lg:flex-row lg:flex-grow lg:items-center lg:w-auto lg:space-y-0 lg:py-10 lg:ml-32 lg:mr-8 z-50`}>
        ...
        <a href={require('../assets/resume.pdf')} rel="nofollow noopener noreferrer" target = "_blank" className={`text-xl px-8 py-4 lg:text-sm lg:px-4 lg:py-2 lg:mr-4 transform ${buttonStyles}`} onClick={handleClick}>Resume</a>
          <div className="flex justify-start items-center text-gray-500">
            <a href="https://github.com/joeylnguyen" className="block flex items-center hover:text-gray-700 mr-3" rel="nofollow noopener noreferrer" target = "_blank">
            ...
            <a href="https://www.linkedin.com/in/joeylnguyen/" className="block flex items-center hover:text-gray-700" rel="nofollow noopener noreferrer" target = "_blank">
