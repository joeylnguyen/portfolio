...
const SideNav = ({ showSideNav, width, handleClick }) => {
  return (
    <div className={`${width < 1024 ? 'visible' : 'hidden'} ${showSideNav ? '-translate-x-0' : 'translate-x-full'} transform top-0 right-0 w-64 h-full bg-gray-100 overflow-auto ease-in-out fixed transition-all duration-500 flex flex-col space-y-10 justify-center p-6 lg:overflow-visible lg:transition-none lg:bg-transparent lg:h-auto lg:relative lg:flex-row lg:flex-grow lg:items-center lg:w-auto lg:space-y-0 lg:py-10 lg:ml-32 lg:mr-8 `}>
      ...
      <div className="text-xl flex flex-col space-y-10 lg:text-sm lg:space-y-0 lg:flex-row items-center lg:flex-grow ">
        <a href="#About" className="transition duration-500 transform hover:-translate-y-1 hover:scale-110 ease-in-out block mt-4 lg:inline-block lg:mt-0 text-gray-600 hover:text-black lg:mr-4">
          About
        </a>
        <a href="#Projects" className="transition duration-500 transform hover:-translate-y-1 hover:scale-110 ease-in-out block mt-4 lg:inline-block lg:mt-0 text-gray-600 hover:text-black lg:mr-4">
          Projects
        </a>
        <a href="#Contact" className="transition duration-500 transform hover:-translate-y-1 hover:scale-110 ease-in-out block mt-4 lg:inline-block lg:mt-0 text-gray-600 hover:text-black">
          Contact
        </a>
      </div>
